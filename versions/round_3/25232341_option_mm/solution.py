...
class RoundThreeTrader(NormalTrader):
    ...
    OPT_MM_BASE_HALF_SPREAD = 3    # base half-spread in ticks
    OPT_MM_SIZE             = 15   # units to post on each side
    OPT_MM_SKEW_PER_UNIT    = 0.03 # inventory skew per unit held (ticks)
    OPT_MM_SPREAD_HIGH_MULT = 1.6  # widen spread by this in high vol regime
    OPT_MM_SPREAD_LOW_MULT  = 0.7  # narrow spread by this in low vol regime

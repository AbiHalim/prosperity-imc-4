...
class RoundThreeTrader(NormalTrader):
    ...
    # Slow alpha → stable estimate; seeded at true realized vol (~27-28%
    # measured at 50-100 tick sampling, significantly above market IV ~20%)
    # RV > IV means options are underpriced → strategy will BUY options.
    DEFAULT_IV  = 0.27

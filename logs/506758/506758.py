...
class Trader(RoundThreeTrader):
    ...
    def _market_make(self, product: str,
        ...
        # Penny the market to capture maximum spread from Dumb Money,
        # but don't quote worse than our ideal price
        ...
        if our_ask <= our_bid:
            # If crossed or locked, default back to ideal prices but ensure gap
            our_bid = our_bid_ideal
            our_ask = max(our_ask_ideal, our_bid + 1)
